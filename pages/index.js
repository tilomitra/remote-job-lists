...
class Index extends Component {
    ...
    render() {
        ...
        let jobCards = this.props.jobs.map((job, i) => {
            return <JobTitle job={job} key={`job-item-${i}`} />;
        });
        return (
            <Layout>
                <Meta
                    ...
                    description={
                        "Remote Job Lists provides a daily updated list of all remote job listings from across the internet. We list remote jobs for engineering, software, marketing, accounting, media, design and more."
                    }
                    url={BASE_URL + this.props.url.asPath}
                />
                <Header
                    searchTerm={this.props.url.query.search}
                ...
                <section className="container">
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <Categories
                                selectedCategories={this.props.url.query.tags}
                            />
                        </div>
                        <div className="col-sm-12">
